...
if(isset($_POST['email'])) {
    ...
    $email_to = "info@somosaliados.org.mx";
 
    $email_subject = "Somos Aliados";   
 ...
 //En esta parte el valor "name" nos sirve para crear las variables que recolectaran la información de cada campo
    ...
    $razon = $_POST['razon']; // requerido
    
    $cluni = $_POST['cluni']; // requerido
    
    $mision = $_POST['mision']; // requerido
...
//A partir de aqui se contruye el cuerpo del mensaje tal y como llegará al correo
    ...
    $email_message .= "Razon: ".clean_string($razon)."\n";
    
    $email_message .= "Cluni: ".clean_string($cluni)."\n";
    
    $email_message .= "Mision: ".clean_string($mision)."\n";
